...
tasks = new SQL.Collection('tasks', 'postgres://meter:Meteor1234@localhost/meteor');
username = new SQL.Collection('username', 'postgres://meter:Meteor1234@localhost/meteor');
